...
export default function Brands(){
    return(
        ...
        <div className="mt-1 border-y border-zinc-300 py-8 text-center rounded-3xl dark:border-zinc-900 md:py-7 xl:mt-2">
            <div className="w-full sm:w-11/12 mx-auto grid grid-cols-2 sm:grid-cols-4  gap-y-3 justify-center items-center">
