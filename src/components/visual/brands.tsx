...
export default function Brands(){
    return(
        ...
        <> 
            <h2 className="text-3xl text-center font-bold tracking-tighter sm:text-4xl xl:text-5xl/none bg-clip-text text-transparent bg-gradient-to-r from-gray-800 to-black dark:from-white dark:to-gray-500">Marcas que nos proveen</h2>

        <div className="mt-12 border-y border-gray-400 py-8 text-center rounded-3xl dark:border-gray-800 md:py-12 xl:mt-20">
