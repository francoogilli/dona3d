  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`bg-white dark:bg-[#050505] `}>
        ...
        <div className="absolute hidden dark:block inset-0 -z-10 h-full w-full bg-[#050505] bg-[linear-gradient(to_right,#0a0a0a_1px,transparent_1px),linear-gradient(to_bottom,#0a0a0a_1px,transparent_1px)] bg-[size:6rem_4rem]"><div className="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_500px_at_50%_200px,#04131d,transparent)]"></div></div>
          <div className="flex">
